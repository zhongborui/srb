...
import com.arui.srb.core.mapper.LendItemMapper;
import com.arui.srb.core.pojo.vo.InvestVO;
import com.arui.srb.core.service.*;
...
public class LendItemServiceImpl extends ServiceImpl<LendItemMapper, LendItem> implements LendItemService {
    ...
    public void investNotify(Map<String, Object> paramMap) {
        ...
        userAccountMapper.updateAmount(bindCode, new BigDecimal("-" + voteAmt), new BigDecimal(voteAmt));
